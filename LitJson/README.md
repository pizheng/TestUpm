...
<root>
  ...
  ├── Editor
  │   ├── Avalonzp.Litjson.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Avalonzp.Litjson.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Avalonzp.Litjson.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Avalonzp.Litjson.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Avalonzp.Litjson`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package LitJson Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Avalonzp.Litjson.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Avalonzp.Litjson.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Avalonzp.Litjson.Editor.Tests.asmdef`

  `Tests/Runtime/Avalonzp.Litjson.Tests.asmdef`
